...
class MeasureBicep(TimestampMixin, Base):
    __tablename__ = "measurements_bicep"
    ...
    user: Mapped["User"] = relationship(back_populates="measurements_bicep")  # type:ignore  # noqa: F821
